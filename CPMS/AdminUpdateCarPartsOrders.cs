...
namespace CPMS
{
    public partial class AdminUpdateCarPartsOrders : Form
    {
        ...
        public AdminUpdateCarPartsOrders()
        {
            InitializeComponent();
        }
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            if (isValidInfo())
            {
                ...
                cmd.CommandText = "update tbl_order_car_parts  set status='" + status + "' where  ocpid='" + id + "' ";
